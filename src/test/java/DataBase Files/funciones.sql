...
INSERT INTO `sisdi`.`t_signature` (`CERTIFICATE_ID`) 
values ("");
INSERT INTO `sisdi`.`t_signature` (`CERTIFICATE_ID`) values ("a2e783b104258b6e6fd28110c7a9cfe7ec305f4d");

INSERT INTO `sisdi`.`t_signature` (`CERTIFICATE_ID`) 
values ("
5OMGamRx7H7kIbf4qM+/q8GH9vKdjVu+eGNv");